...
# 'season_number', 'tags', 'display_id', 'id', 'average_rating', 'automatic_captions',
# 'webpage_url_basename', 'start_time', 'extractor', 'preference', 'age_limit',
# 'protocol', 'end_time', 'abr', 'thumbnail', 'annotations', 'uploader',
# 'requested_subtitles', 'http_headers', 'license', 'acodec', 'creator', 'uploader_id',
# 'vcodec', 'categories', 'thumbnails','subtitles', 'format_id', 'alt_title',
# 'webpage_url', 'format_note', 'is_live', 'player_url', 'upload_date'])
#
# Twitch object keys
# dict_keys(['webpage_url_basename', 'playlist', 'extractor', 'id', 'extractor_key',
# 'uploader', 'http_headers', 'title', 'thumbnail', 'height', 'thumbnails',
# 'requested_subtitles', 'protocol', 'formats', 'ext', 'uploader_id', 'format',
